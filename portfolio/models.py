...
class Profile(models.Model):
    ...
    blog = models.URLField('BlogのURL', null=True, blank=True)
    github = models.URLField('githubのURL', null=True, blank=True)
    introduction = models.TextField('自己紹介文')
    mail = models.CharField('メール', max_length=255)
...
class Skill(models.Model):
    ...
    description = models.ForeignKey(
        Description, on_delete=models.SET_NULL, null=True, verbose_name='説明文')
